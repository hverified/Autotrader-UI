...
import { RefreshCw, Trash2, Download, Activity, AlertCircle, Info, AlertTriangle, FileText, Sparkles } from "lucide-react";
...
export default function Logs() {
    ...
    const getLevelColor = (level) => {
        const colors = {
            ...
            DEBUG: "bg-slate-50 text-slate-700 border border-slate-200",
        };
        return colors[level] || "bg-slate-50 text-slate-700 border border-slate-200";
    };
    ...
    return (
        <div className="pb-16 sm:pb-0 p-4 sm:p-6 bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-50 min-h-screen">
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 sm:mb-8 gap-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                        <button
                            ...
                            className="group px-4 py-2.5 text-sm font-medium text-slate-700 bg-white/90 backdrop-blur-sm border border-slate-200 rounded-xl shadow-sm hover:shadow-md hover:bg-white hover:border-slate-300 transition-all duration-200 flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                            disabled={refreshing}
                        >
                        ...
                        <button
                            ...
                            className="group px-4 py-2.5 text-sm font-medium text-white bg-gradient-to-r from-red-600 to-red-500 rounded-xl shadow-md shadow-red-500/30 hover:shadow-lg hover:shadow-red-500/40 hover:from-red-700 hover:to-red-600 transition-all duration-200 flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed active:scale-95"
                            disabled={refreshing}
                        >
                            <Trash2 size={16} />
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mb-6">
                    <div className="group bg-white/90 backdrop-blur-sm rounded-2xl shadow-sm hover:shadow-md p-4 sm:p-5 border border-slate-200/60 hover:border-slate-300 transition-all duration-200">
                        <div className="flex items-center justify-between mb-2">
                            ...
                            <Activity size={18} className="text-slate-400 group-hover:text-slate-600 transition-colors" />
                        </div>
                ...
                {/* Filters */}
                <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-sm p-4 sm:p-5 mb-6 border border-slate-200/60">
                    <div className="flex flex-col sm:flex-row gap-4">
                        <div className="flex-1">
                            ...
                            <select
                                ...
                                className="w-full px-4 py-2.5 text-sm border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white hover:border-slate-300 transition-all"
                            >
                                ...
                                {logs.length > 0 ? (
                                    logs.map((log, index) => (
                                        ...
                                        >
                                            ...
                                            <div className="md:hidden space-y-3">
                                                ...
                                                <p className="text-sm text-slate-700 leading-relaxed break-words bg-slate-50 p-3 rounded-lg">
                                                    {log.message}
                                                </p>
                                            </div>
                                            ...
                                            <div className="hidden md:flex items-start gap-4">
                                                <div className="w-2/12">
                                                    <span className="text-sm font-medium text-slate-500 bg-slate-100 group-hover:bg-blue-100 px-2 py-1 rounded-lg transition-colors">
                                                        {log.timestamp}
                                                    </span>
                                                </div>
                                    ...
                                    <div className="text-center py-24 px-4">
                                        ...
                                        <p className="text-slate-500 text-sm max-w-md mx-auto">
                                            Logs will appear here when generated by the application
                                        </p>
                                    </div>
                                )}
                            </div>
