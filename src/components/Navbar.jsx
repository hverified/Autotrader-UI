...
export default function Navbar() {
  ...
  const getMobileLinkStyle = ({ isActive }) =>
    `block w-full text-left px-3 py-2 rounded-md text-base font-semibold transition-colors duration-200 ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center py-3">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <NavLink to="/shortlist" className={getLinkStyle}>
              Shortlist
            </NavLink>
          </div>
      ...
      {isMenuOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <NavLink to="/" className={getMobileLinkStyle} onClick={() => setIsMenuOpen(false)}>
              Dashboard
            </NavLink>
            <NavLink to="/shortlist" className={getMobileLinkStyle} onClick={() => setIsMenuOpen(false)}>
              Shortlist
            </NavLink>
          </div>
        </div>
